...
(function buildSdrPanel() {
    ...
    function tune() {
        ...
        displayFreq(hz);
        if (window._SdrAudio) {
            window._SdrAudio.initAudio((_a = getSelectedRadioId()) !== null && _a !== void 0 ? _a : undefined);
    ...
    function getEfMode() {
        ...
        return (_a = active === null || active === void 0 ? void 0 : active.dataset.mode) !== null && _a !== void 0 ? _a : 'AM';
    }
