...
const AARA_ZONES: GeoJSON.FeatureCollection<GeoJSON.Polygon, ZoneProperties> = {
...
class AARToggleControl extends SentinelControlBase {
    visible: boolean;
    ...
    get buttonTitle(): string { return 'Toggle UK air-to-air refuelling areas'; }
